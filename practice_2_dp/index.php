<?php
    ...
    // отличается от require тем, что если файла нет, то будет warning, а не фатальная ошибка
    //require ('data.php');
ini_set("display_errors", 1);
error_reporting(E_ERROR | E_WARNING | E_PARSE);
$db = require_once ('dbwork.php');
    ...
    <div class="wrapper">
        ...
        <div class="main-wrapper">
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            ...
                            <div class="time"><?= $job['startYear'] ?> - <?= $job['finish'] ?></div>
                        </div><!--//upper-row-->
            ...
            if ($_POST['comment']) {
                ...
                $connection->query("INSERT INTO comments (comment) VALUE 
                ('$newComment')");
            }
